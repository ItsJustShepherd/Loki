...
def decrypt():
        try:
            print("\n") # Gaps the text.
            print(f"{print_question} What directory would you like to decrypt.\n") # Preferable to state the full working directory.
            dir_encrypt = input(f"{print_command} ")
            print("\n") # Gaps the text.
            os.system(f"cp ./src/modules/decryptor.py {dir_encrypt}")
            ...
            os.system(f"python3 {dir_encrypt}/decryptor.py") # Runs probe in the stated dir.
            os.system("rm decryptor.py") # Removes traces of the probe.
